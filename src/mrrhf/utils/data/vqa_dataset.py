...
class VQADataset(Dataset):
    ...
    def process_image(self, ann, data_debug_path=None, data_debug_counter=0):
        ...
        try:
            ...
            return image_outputs, ann["image"]
    ...
    def merge_all_images(self, res_list, text):
        image_number = 0
        original_output = {"input_ids": [], "attention_mask": [], "labels": [], "image": [], "score": [], "query_id":[], "img_path":[]} #copy.deepcopy(self.system_instruct)
        for res in res_list:
            ...
            original_output["img_path"].append(res["img_path"])
