...
DEFAULT_LABEL_PADDING_NUM = -100 # lkj：计算损失的，如果没有使用generate来推理就是需要这个东西，来限制计算损失
...
LLAMA_3_TEMPLATE = {
    ...
    "prompt_qa_with_image": f'''{LLAMA3_HUMAN_QUESTION_PRETOKEN}{DEFAULT_IMAGE_TOKEN}\n{DEFAULT_QUESTION_TOKEN}{LLAMA3_HUMAN_QUESTION_PRETOKEN_END}{LLAMA3_ASSISTANT_TOKEN}''',
