...
from basicsr_ridcp.utils.registry import ARCH_REGISTRY
from basicsr_ridcp.ops.dcn import ModulatedDeformConvPack, modulated_deform_conv
...
class VectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e, e_dim, weight_path='RIDCP/pretrained_models/weight_for_matching_dehazing_Flickr.pth', beta=0.25, LQ_stage=False, use_weight=True, weight_alpha=1.0):
        super().__init__()
        self.n_e = int(n_e)
...
class VQWeightDehazeNet(nn.Module):
    def __init__(self,
                 *,
                 ...
                 use_warp=True,
                 weight_alpha=1.0,
                 weight_path='RIDCP/pretrained_models/weight_for_matching_dehazing_Flickr.pth',
                 **ignore_kwargs):
        super().__init__()
