...
import llama_361
import transformers
from llama_361.modeling_llama_ import *
from llama_361.modeling_llama_ import *
...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, layer_idx):
        ...
        # self.self_attn = LLAMA_ATTENTION_CLASSES[config._attn_implementation](config=config, layer_idx=layer_idx) # lkj：原本有的
...
def replace_llama_modality_adaptive():
    llama_361.configuration_llama_.LlamaConfig = LlamaConfig
    llama_361.modeling_llama_.LlamaAttention = LlamaAttention
    llama_361.modeling_llama_.LlamaFlashAttention2 = LlamaFlashAttention2
    llama_361.modeling_llama_.LlamaSdpaAttention = LlamaSdpaAttention
    llama_361.modeling_llama_.LlamaDecoderLayer = LlamaDecoderLayer
    llama_361.modeling_llama_.LlamaModel.forward = model_forward
    llama_361.modeling_llama_.LlamaForCausalLM.forward = causal_model_forward
