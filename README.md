...
- 2025.11.25: Release the [tokenizer.json](https://github.com/user-attachments/files/23749469/tokenizer.json)🚀. It replace the [tokenizer.json](https://huggingface.co/LYL1015/JarvisIR/resolve/main/pretrained/mrrhf/tokenizer.json) file that fails to download properly in huggingface.
